...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[0].position"), pointLightPositions[4].x, pointLightPositions[4].y, pointLightPositions[4].z);
		...
		glUniform1f(glGetUniformLocation(lightingShader.Program, "pointLights[0].linear"), 0.003f);
		glUniform1f(glGetUniformLocation(lightingShader.Program, "pointLights[0].quadratic"), 0.3f);
		...
		glUniform1f(glGetUniformLocation(lightingShader.Program, "pointLights[1].linear"), 0.003f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.direction"), pointLightPositions[5].x, pointLightPositions[5].y, pointLightPositions[5].z);
...
void DoMovement()
{
	...
	if (keys[GLFW_KEY_Y])
	{
		pointLightPositions[0].y += 0.01f;				//SUMA EN X
	}

	if (keys[GLFW_KEY_H])
	{
		pointLightPositions[0].y -= 0.01f;				//RESTA EN X
	}
	if (keys[GLFW_KEY_U])
	{
	...
	if (keys[GLFW_KEY_N])
	{
		pointLightPositions[5].y += 0.01f;				//SUMA EN X
	}

	if (keys[GLFW_KEY_M])
	{
		pointLightPositions[5].y -= 0.01f;				//RESTA EN X
	}
	if (keys[GLFW_KEY_V])
	{
		pointLightPositions[5].z += 0.1f;
	}
	if (keys[GLFW_KEY_B])
	{
		pointLightPositions[5].z -= 0.01f;
	}
